...
label ending_one:
    ...
    "For a brief moment, she remains standing. As if her body hasn't realized what's happened."
    hide sakura with vpunch
    camera:
        linear 1.0 zoom 1.0
    "She collapses onto the sofa, one trembling hand pressed against the wound."
    s "Nngh..."
    s "Nngh..."
    s "..."
    u "..."
    ...
    "My stomach twists."
    "I quickly turn away and begin coughing."
    "Just looking at the blood makes me want to throw up."
    u "D-Did she-"
    i "Kaori Ito is dead."
    i "Congratulations on completing your first case, [first_name] [last_name]."
    u "W-Was it really her?"
    i "Does the truth matter anymore? She's dead."
    u "..."
    u "So that's it?"
    u "This school forces us to kill each other, and you call that justice?"
    i "..."
    u "What's the point of any of this?"
    u "How is a detective supposed to live with a decision like this..."
    u "Without ever knowing if it was the right one?"
    i "..."
    u "Answer me!"
    ...
    i "You'll never know whether you served justice..."
    i "...or condemned an innocent person. Not everyone tells the truth."
    i "That is the reality of the world you're about to enter."
    i "Now..."
    i "Return to your life."
    i "If you're still capable of living it."
    ...
    k "And yet... Deep down..."
    k "Part of me is relieved."
    k "He chose me."
    k "..."
    i "Do you think he feels the same way?"
    k "I don't know. Maybe."
    k "But he had every reason to choose me."
    k "Everything pointed to me. He knew Kaori was innocent."
    k "And he still chose her."
    k "..."
    i "Don't dwell on it. You're free to return to the life you had before."
    k "I wonder if I can."
    i "..."
    show kaori happy with dissolve
    ...
    "We meet outside the apartment building."
    "Ivy's eyes are red. She must have been crying."
    "I don't say anything. I don't know what I could possibly say."
    ...
    k "It’s okay. I don't think you'll stop thinking about today anytime soon."
    u "Yeah..."
    u "Why are you still with me?"
    k "..."
    k "I didn't want you to be alone."
    ...
    "It's the same smile I've known for years."
    "It feels different today."
    "Maybe because, right now, it's the only thing keeping me from falling apart."
    ...
    "I squeeze back."
    "Neither of us says another word as we continue walking home together."
    pause 1.0
    hide kaori with dissolve
    scene black with fade
...
label ending_three:
    ...
    s "That's okay. I know it's been hard."
    u "..."
    u "Yeah..."
    ...
    u "The final test? Oh... yeah, I think so. Are you?"
    s "I'm trying not to think about it. I'm a little nervous."
    u "Heh. You'll do fine. I know you will."
    s "Thanks, [first_name]."
    u "Um..."
    u "Actually..."
    u "Would you like to go see a movie with me tomorrow?"
    u "There's a new comedy playing. I heard it's pretty good."
    s "A movie..."
    s "With you?"
    show sakura blush with dissolve
    s "I-I'd love to."
    ...
    s "It's a date."
    s "Hehe."
    "Her smile makes my chest feel a little lighter."
    ...
    "The academy still refuses to tell me whether Ivy was really the killer."
    ...
    scene kitchen_night with fade
    "I enter an apartment. It's dark"
    scene kitchen_day
    "I switch on the lights and head toward Ivy's room."
    i "You're not supposed to be here."
    u "Damn it! I always forget you can do that."
    i "Entering the women's dormitory without authorization is prohibited."
    u "Come on... She's gone."
    scene bedroom2:
        zoom 1.5
    with fade
    "I step into Ivy's room."
    "Everything is exactly as she left it."
    "My eyes stop on the blue hoodie hanging over the back of her chair."
    "Was this the one from that night?"
    "I pick it up and check the pockets. Something falls onto the floor."
    "A flash drive."
    "I insert it into the laptop on her desk."
    "Inside, I find a single file."
    "'Untitled1.mp4'"
    scene black with fade
    pause 0.5
    ...
    k "If you're watching this... then you chose me."
    show kaori happy with dissolve
    k "Hehe. Not exactly the outcome I was hoping for."
    show kaori normal with dissolve
    k "I don't know if this is the right time to tell you the truth."
    ...
    k "I saw it with my own eyes."
    k "I saw your face. I watched you kill him."
    "What?"
    "That's impossible. I don't rem-"
    show kaori serious with dissolve
    k "I think it's called dissociative amnesia."
    k "Memory loss caused by severe psychological trauma."
    k "Sometimes the mind buries memories that are too painful to face."
    k "Sometimes it even erases what happened before and after."
    k "..."
    k "You were the one wearing that hoodie."
    k "After Hiro died..."
    k "You threw it away..."
    k "... and ran."
    k "I didn't know what to think."
    k "I only knew one thing."
    k "If anyone found that hoodie, they would find you."
    k "That's why I decided to make myself a suspect instead."
    k "..."
    k "I still don't know if it was the right decision."
    k "But I don't regret it."
    k "..." 
    k "The next morning, I came to see you. I wanted to talk to you. To figure out what to do."
    ...
    k "I can't imagine what you went through."
    k "You were completely alone."
    k "..."
    ...
    k "You idiot."
    k "Do you have any idea how much that hurt?"
    k "..."
    k "You even forgot the truth about Hiro."
    k "That's when I realized how serious it was."
    ...
    k "She's innocent."
    show kaori serious with dissolve
    k "I'm the one who told the academy about her meeting with Hiro."
    k "I made her a suspect."
    ...
    k "I want to stay by your side."
    k "I want to graduate with you."
    k "I want to walk to school together again."
    k "I want to work at the same company."
    k "I want all of it."
    "Her voice cracks."
    k "Even if someone innocent had to pay the price."
    k "Even if that makes me a terrible person."
    k "..."
    k "Your memories..."
    k "They'll probably return eventually."
    k "I wanted you to hear the truth from me."
    k "So you wouldn't have to face them alone."
    k "..."
    k "But that's not completely true either."
    k "The truth is, I want you to remember me."
    k "I want to be the person you think about."
    k "The person you could never forget."
    k "The person who loved you more than anyone else."
    "She lets out a weak, tearful laugh."
    k "..."
    k "Heh."
    k "How pathetic."
    ...
    u "..."
    "All that's left..."
    "...is the dark stain where her blood dried."
    pause 2.0
